...
class AreaRepository: ObservableObject {
    ...
    func createArea(
        ...
        return try await supabaseService.insert(area, into: SupabaseService.TableName.areas)
    }
    
    /// Fetch all areas
    func fetchAllAreas() async throws -> [Area] {
        let response: [Area] = try await supabaseService.client
            .from(SupabaseService.TableName.areas)
            .select()
    ...
    func fetchArea(id: UUID) async throws -> Area? {
        return try await supabaseService.fetchById(Area.self, from: SupabaseService.TableName.areas, id: id)
    }
    ...
    func updateArea(_ area: Area) async throws -> Area {
        return try await supabaseService.update(
            area,
            in: SupabaseService.TableName.areas,
            matching: "id",
    ...
    func getProjectCountsByArea() async throws -> [UUID: Int] {
        let projects = try await supabaseService.fetch(Project.self, from: SupabaseService.TableName.projects)
        var counts: [UUID: Int] = [:]
...
class ResourceRepository: ObservableObject {
    ...
    func createResource(
        ...
        return try await supabaseService.insert(resource, into: SupabaseService.TableName.resources)
    }
    ...
    func fetchAllResources() async throws -> [Resource] {
        let response: [Resource] = try await supabaseService.client
            .from(SupabaseService.TableName.resources)
            .select()
    ...
    func fetchResource(id: UUID) async throws -> Resource? {
        return try await supabaseService.fetchById(Resource.self, from: SupabaseService.TableName.resources, id: id)
    }
    ...
    func updateResource(_ resource: Resource) async throws -> Resource {
        return try await supabaseService.update(
            resource,
            in: SupabaseService.TableName.resources,
            matching: "id",
    ...
    func archiveResource(id: UUID) async throws {
        try await supabaseService.client
            .from(SupabaseService.TableName.resources)
            .update(["is_archived": true, "archived_at": ISO8601DateFormatter().string(from: Date())])
    ...
    func assignTag(resourceId: UUID, tagId: UUID) async throws -> ResourceTag {
        ...
        return try await supabaseService.insert(resourceTag, into: SupabaseService.TableName.resourceTags)
    }
    
    /// Remove tag from resource
    func removeTag(resourceId: UUID, tagId: UUID) async throws {
        try await supabaseService.client
            .from(SupabaseService.TableName.resourceTags)
            .delete()
...
class PromptLogRepository: ObservableObject {
    ...
    func logPrompt(
        ...
        return try await supabaseService.insert(promptLog, into: SupabaseService.TableName.promptLogs)
    }
    ...
    func fetchAllPromptLogs() async throws -> [PromptLog] {
        let response: [PromptLog] = try await supabaseService.client
            .from(SupabaseService.TableName.promptLogs)
            .select()
            .order("created_at", ascending: false)
            .execute()
            .value
